		 ...
		 <div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<select name="category_id" class="form-select" id="inputVendor">
						...
						<option value="{{ $cat->id }}" {{ ($blogPost->category_id == $cat->id) ? 'selected' : '' }}>{{ $cat->blog_category_name }}</option>
						 @endforeach
					  </select>
				</div>
			</div>
...
<div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<textarea id="mytextarea" name="post_long_description">{!! $blogPost->post_short_description !!} </textarea>          
				</div>
			</div>
