@php
 $crrrentRoute = Route::current()->getName();
@endphp
...
<div class="col-md-3">
  <div class="dashboard-menu">
      <ul class="nav flex-column" role="tablist">
          <li class="nav-item">
              <a class="nav-link {{ ( $crrrentRoute == 'dashboard' ? 'active' : '' ) }}" href="{{ route('dashboard') }}"><i class="fi-rs-settings-sliders mr-10"></i>Dashboard</a>
          </li>
          <li class="nav-item">
              <a class="nav-link {{ ( $crrrentRoute == 'user.order.page' ? 'active' : '' ) }}" href="{{ route('user.order.page') }}"><i class="fi-rs-shopping-bag mr-10"></i>Orders</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
              <a class="nav-link {{ ( $crrrentRoute == 'user.acount.page' ? 'active' : '' ) }}" href="{{ route('user.acount.page') }}"><i class="fi-rs-user mr-10"></i>Account details</a>
          </li>
          <li class="nav-item">
