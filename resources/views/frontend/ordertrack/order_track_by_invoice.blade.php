...
<div class="container">
    <article class="card">
     ...
     <div class="col"> <strong>Shipping To:</strong> <br> {{ $track->name }} | <i class="fa fa-phone"></i>{{ $track->phone }} / {{ $track->division->division_name }} / {{ $track->district->districts_name }}   </div>
