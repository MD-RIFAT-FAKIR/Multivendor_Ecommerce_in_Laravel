...
@php 
	$date = date('d-m-y');
	$todays_sale = App\Models\Order::where('order_date', $date)->sum('amount');
	...
	$totalUser = App\Models\User::where('role','user')->where('status','active')->get();
	
	$totalVendor = App\Models\User::where('role','vendor')->where('status','active')->get();
...
<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
	<div class="col">
		<div class="card radius-10 bg-gradient-deepblue">
			...
			<div class="d-flex align-items-center">
				<h5 class="mb-0 text-white">${{ $todays_sale }} USD</h5>
				<div class="ms-auto">
	...
	<div class="col">
		...
		<div class="card-body">
			<div class="d-flex align-items-center">
				<h5 class="mb-0 text-white">${{ $monthly_sale }} USD</h5>
				<div class="ms-auto">
	...
	<div class="col">
		...
		<div class="card-body">
			<div class="d-flex align-items-center">
				<h5 class="mb-0 text-white">${{ $yearly_sale }} USD</h5>
				<div class="ms-auto">
	...
	<div class="col">
		<div class="card radius-10 bg-gradient-ibiza">
			<div class="card-body">
			<div class="d-flex align-items-center">
				<h5 class="mb-0 text-white">{{ count($pendingOrders) }}</h5>
				<div class="ms-auto">
	...
	<div class="col">
		<div class="card radius-10 bg-gradient-ibiza">
			<div class="card-body">
			<div class="d-flex align-items-center">
				<h5 class="mb-0 text-white">{{ count($totalUser) }}</h5>
				<div class="ms-auto">
					<i class='bx bx-envelope fs-3 text-white'></i>
				</div>
			</div>
	...
	<div class="col">
		...
		<div class="card-body">
			<div class="d-flex align-items-center">
				<h5 class="mb-0 text-white">{{ count($totalVendor) }}</h5>
				<div class="ms-auto">
					<i class='bx bx-group fs-3 text-white'></i>
				</div>
			</div>
